<?php
    ...
    $user = $_SESSION['user'];
 /* link img CEO;  /*(link img CEO)https://www.google.com/search?q=user&tbm=isch&hl=en-GB&chips=q:user,g_1:profile:CaToCCdMP9c%3D&sa=X&ved=2ahUKEwjf6P7r4ej_AhX3_zgGHVg1AUoQ4lYoAXoECAEQKg&biw=750&bih=719#imgrc=1z9MJwjopAk2-M */; 
?>
...
<html>
    ...
    <body>
     ...
     <form action="attand.php"  method="POST" class="appForm" >
    ...
    <div class="elem-group" class="appFormInputContainer">
      ...
      <input type="tel" class="appFormInput" id="email" name="customer_email"  required>
    </div>
    <div class="elem-group inlined" class="appFormInputContainer">
      <label for="checkin_date">Date</label>
      <input type="date" class="appFormInput" id="checkin_date" name="checkin" required>
    </div>
    <div class="elem-group" class="appFormInputContainer">
    ...
    <div class="elem-group" class="appFormInputContainer">
      <label for="kehadiran_selection">Attandance</label>
      <select id="kehadiran-selection" name="kehadiran" required>
