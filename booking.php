...
<html>
    ...
    <body>
     ...
     <form action="connects.php"  method="POST" class="appForm" >
    <div class="elem-group"   class="appFormInputContainer">
      <label for="name">Your Name</label>
      <input type="text" class="appFormInput" id="name" name="customer_name" placeholder="John Doe" pattern=[A-Z\sa-z]{3,20} required>
    </div>
    <div class="elem-group" class="appFormInputContainer">
      <label for="email">Your E-mail</label>
      <input type="email" class="appFormInput" id="email" name="customer_email" placeholder="" required>
    </div>
    <div class="elem-group" class="appFormInputContainer">
    ...
    <div class="elem-group inlined"  class="appFormInputContainer">
      ...
      <input type="number" class="appFormInput" id="adult" name="total_adults" placeholder="2" min="2" max="6" required>
    </div>
    <div class="elem-group inlined" class="appFormInputContainer">
      <label for="checkin-date">Date</label>
      <input type="date" class="appFormInput" id="checkin-date" name="checkin" required>
    </div>
    <div class="elem-group inlined " class="appFormInputContainer">
    ...
    <button type="submit" class="appBtn">Book The Court</button>
