...
<html>
    ...
    <body>
     ...
     <form action="book.php"  method="POST" class="appForm" >
    ...
    <div class="elem-group" class="appFormInputContainer">
      <label for="equip-selection">Select For Equipment</label>
      <select id="equip-selection" name="equip_preference" required>
          <option value="">Choose a equipment from the List</option>
          <option value="Racket ">Racket (RM 5 per)</option>
          <option value="Shuttlecock">Shuttlecock(RM 3 per)</option>
          <option value="Both">Both</option>
      </select>
    </div>
    <div class="elem-group" class="appFormInputContainer">
      <label for="Qty">Quantity racket</label>
      <input type="Qty" class="appFormInput" id="Qty" name="Qty"  required>
    </div>
    <div class="elem-group" class="appFormInputContainer">
      <label for="shuttle">Quantity Shuttlecock</label>
      <input type="shuttle" class="appFormInput" id="shuttle" name="shuttle"  required>
    </div>
    <div class="elem-group " class="appFormInputContainer">
        <label for="total">Total</label>
        <input type="total" class="appFormInput" id="total" name="total" placeholder="RM " required>
      </div>
